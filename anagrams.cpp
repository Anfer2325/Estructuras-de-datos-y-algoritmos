...
int main(){
	Arbus<string,string> a;
	Arbus<string, int> veces;
	...
	Arbus<string, int>::Iterador itv = veces.principio();
	...
	i=0;
	Arbus<string,string>::Iterador ita = a.principio();
	string solucion[maxPal];
	while(ita!=a.final()){
		//cout << ita.valor() << endl;
